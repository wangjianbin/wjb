...
<body>
    <center>
        <br>
        <s:form theme="simple">
        <input type="hidden" name="moneyID" value="<s:property value="info.id"/>">
        ...
        <table border="0" width="645" cellpadding="10" cellspacing="0" style="word-break:break-all">            
            <tr height="30">
                <td style="text-indent:5"><b>付费设置 [ID值：<s:property value="info.id"/>]</b></td>
            ...
            <tr height="40" bgcolor="#F9F9F9">
                ...
                <td align="center">
                    <s:if test="info.infopayfor==1"><s:set name="forbid" value="true"/></s:if>
                    <s:else><s:set name="forbid" value="false"/></s:else>
                    <s:submit action="adminSetMoney" value="√设为付费" disabled="forbid"/>
                </td>
